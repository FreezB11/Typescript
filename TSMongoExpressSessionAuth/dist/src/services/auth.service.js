...
exports.resetPassword = exports.adminRegistersUser = void 0;
...
({ email, password, username, accessLevels }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //generate avatar
    let avatar = (0, generateAvatar_1.default)();
    //create a new user
...
const resetPassword = ({ user, newPassword, }) => __awaiter(void 0, void 0, void 0, function* () {
    //reset the users password
    let userToReset = yield User_1.default.findOne({ _id: user });
    if (!userToReset) {
        return {
